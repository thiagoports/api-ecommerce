...
function mapApiProductToFE(p: ApiProduct): FEProduct {
  ...
  return {
    ...
    images: ['https://images.unsplash.com/photo-1585386959984-a41552231658?w=1200'],
    specs: {},
    reviews: [],
    rating: 0,
    isNew: false,
...
export const ProductDetail: React.FC = () => {
  ...
  const product = useMemo(() => (apiProduct ? mapApiProductToFE(apiProduct as ApiProduct) : null), [apiProduct]);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-16">
        <div className="space-y-4">
          <div className="aspect-square rounded-xl overflow-hidden bg-gray-100 relative group">
            ...
            />
            {product.isNew && (
              <Badge className="absolute top-4 left-4 bg-[#6A1B9A] text-white">Novo</Badge>
            )}
            {product.isBestSeller && (
              <Badge className="absolute top-4 right-4 bg-green-600 text-white">Mais Vendido</Badge>
            )}
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-4xl text-[#6A1B9A] mb-6">R$ {product.price.toFixed(2)}</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg">
                ...
                <span className="px-6 py-3 border-x border-gray-300 min-w-[60px] text-center">{quantity}</span>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button onClick={handleAddToCart} className="flex-1 bg-[#6A1B9A] hover:bg-[#7D22B2] text-white h-12 text-lg">
      ...
      <Tabs defaultValue="specs" className="mb-16">
        <TabsList className="w-full justify-start border-b rounded-none h-auto p-0 bg-transparent">
          <TabsTrigger value="specs" className="data-[state=active]:border-b-2 data-[state=active]:border-[#6A1B9A] rounded-none px-6 py-3">
            Especificações Técnicas
          </TabsTrigger>
          <TabsTrigger value="reviews" className="data-[state=active]:border-b-2 data-[state=active]:border-[#6A1B9A] rounded-none px-6 py-3">
      ...
      {relatedProducts.length > 0 && (
        <div>
          <h2 className="text-2xl md:text-3xl text-gray-900 mb-8">Produtos Relacionados</h2>
